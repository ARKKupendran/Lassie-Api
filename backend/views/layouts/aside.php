    ...
    <section class="sidebar">
        ...
        echo Menu::widget([
            ...
            'items' => [
                    ...
                    'items' => [
                            ['label' => '<i class="fa fa-circle-o"></i>All Users', 'url' => ['users/index']],
                            ['label' => '<i class="fa fa-circle-o"></i>Add User', 'url' => ['users/create']],
                    ]],
                    ['label' => '<i class="fa fa-users"></i> <span>Pets Management</span><i class="fa fa-angle-left pull-right"></i>',
                    'url' => ['#'],
                    'options' => ['class' => 'treeview'],
                    'items' => [
