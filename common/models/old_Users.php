    ...
    public function authenticate() {
        ...
        if ($userinfo === null):
            ...
            return Yii::$app->mailer->compose()
                            ...
                            ->setTo($toemail)
                            ->setSubject('Lassie Local - Request to reset your password')
                            ->setHtmlBody('Hi, <br/><br/> We have received your request to reset your password.<br/><br/> Please note the new password  <b>' . $randpass . '</b> which is to be used to login <br/><br/>Thanks, <br/><br/> Lassie Team.')
                            ->send();
        endif;
    }
